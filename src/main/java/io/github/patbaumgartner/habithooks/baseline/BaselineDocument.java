 ...
 *
 * <p>The file is committed to version control and records known violations that
 * should be suppressed (snoozed) until the file is touched.
 */
public class BaselineDocument {
    ...
    /**
     * Map of workspace-relative file path → baseline entry. Only files with
     * snoozed violations appear here.
     */
    ...
    public static class BaselineEntry {
        ...
        /** Git commit hash of the last commit touching this file when the baseline was taken. */
